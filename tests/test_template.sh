...
# Uncomment the following line if you don't want the output of the shell to be
# compared against the output of /bin/. It can be useful when you want to check
# a builtin command that sh doesn't implement.
...
# ERROR_OUTFILE -> Path to the file containing the stderr of the shell
# OUTFILE -> Path to the file containing the stdout of the shell
# STATUS -> Path to the file containing the exit status of the shell
# EXPECTED_ERROR_OUTFILE -> Path to the file continaing the stderr of sh
# EXPECTED_OUTFILE -> Path to the file containing the stdout of sh
